...
function calculate(initial=0){
    ...
    if (result>=53&&result%53!=0&& (result%53)%4==0){
        return document.getElementById("result").innerHTML="It will take you "+parseInt(result/53)+" years and"+(result%53)+"and weeks";}
    else if (result>=53&&result%53!=0){
        return document.getElementById("result").innerHTML="It will take you "+parseInt(result/53)+" years"+(result%53)+" months and "+((result%53)%4)+" weeks";}
    else if (result>=53&&result%53==0){
